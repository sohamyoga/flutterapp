...
//     }
//     if (b) {
//       player=await audioCacheBG.loop(isSkip,mode:PlayerMode.MEDIA_PLAYER
//         // isNotification: true
...
//                     widget._modelExerciseList[pos].exercise_id),
//                 builder: (context, snapshot) {
//                   if (snapshot.hasData) {
//                     ModelExerciseDetail _modelExerciseDetail = snapshot.data;
//                     if (isSkip) {
//                       // (() async {
//                       //   await _speak("Take a rest");
//                       //   setState(() {});
//                       // })();
//
//
...
//                       //     _modelExerciseDetail, setDataByPos,null, true,null);
...
//                 future: null,
//                 builder: (context, snapshot) {
//                   _dataHelper.addCompleteChallengeData(
//                       widget._modelExerciseList[0].week,
//                       widget._modelExerciseList[0].day,
//                       widget._modelDummySend.id);
//
//                   _dataHelper.addHistoryData(
//                       "${widget._modelDummySend.title} Day${widget._modelExerciseList[0].day}",
//                       startTime,
//                       totalDuration,
//                       (totalDuration * Constants.calDefaultCalculation)
//                           .toString(),
